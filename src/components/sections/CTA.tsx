      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] glass-strong">
            ...
            <div className="absolute -left-20 bottom-0 h-[400px] w-[600px] rounded-full bg-primary/15 blur-3xl" />
            <div className="absolute -right-20 top-0 h-[300px] w-[400px] rounded-full bg-white/[0.04] blur-3xl" />
